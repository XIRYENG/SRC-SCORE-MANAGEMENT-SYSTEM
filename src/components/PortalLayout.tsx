    ...
    <div className="h-[100dvh] w-full bg-[#F8FAFC] text-slate-900 overflow-hidden relative">
      <div className="flex h-full w-full overflow-hidden bg-[#F8FAFC]">
        ...
        <div className="flex w-full flex-col h-full min-h-0 overflow-hidden">
          <header className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-slate-200 bg-white/80 px-4 backdrop-blur-md lg:h-20 lg:px-8 shrink-0">
            <div className="flex items-center gap-3 lg:hidden">
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-50 text-slate-900"
              >
                <Menu size={20} />
              </button>
              <div className="flex flex-col">
                <h1 className="text-[11px] font-black uppercase tracking-wider">{title}</h1>
                {role === "Reviewee" && seqId && (
                  <span className="text-xs font-black text-teal-600 leading-none mt-0.5">ID: {seqId}</span>
                )}
              </div>
            </div>
            ...
            <div className="hidden lg:block">
               ...
               {role === "Reviewee" && seqId && (
                 <div className="text-lg font-black text-slate-800 tracking-tight mt-0.5">ID: {seqId}</div>
               )}
